    ...
    private Fragment getHomeFragment() {
        ...
        switch (navItemIndex) {
            ...
            case 4:
                ...
                return identifysaplings;
            case 5:
                // socialise
                Socialise socialise = new Socialise();
                return socialise;
            case 6:
                // notifications
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_track_plantations:
                        ...
                        startActivity(new Intent(MainActivity.this, TrackPlantations.class));
                        drawer.closeDrawers();
                        return true;
                    ...
                    case R.id.nav_identify_saplings:
                        ...
                        break;
                    case R.id.nav_socialise:
                        navItemIndex = 5;
                        CURRENT_TAG = TAG_SOCIALISE;
                        break;
